...
const PROJECTS: Project[] = [
  {
    ...
    slug: "burhani-plaza",
    name: "Burhani Plaza",
    subtitle: "Shops & 2/3 BHK specious apartments",
    category: "Residential",
    location: "Ajwa Road, Vadodara",
    image: "/images/Burhani-plaza.png",
    status: "Ongoing",
    year: "2024",
    area: "2.5 Acres",
    units: 128,
  ...
  },
  {
    ...
    slug: "fakhri-colony",
    name: "Fakhri Colony",
    subtitle: "Open Plot Scehme Seguwada, Dabhoi Road, Vadodara",
    category: "Residential",
    location: "Seguwada, Dabhoi Road, Vadodara",
    image: "/images/fakhri-colony.png",
    status: "Completed",
    year: "2022",
    area: "1.8 Acres",
    units: 96,
  ...
  {
    id: 3,
    slug: "Bhagyalaxmi-riverfront",
    name: "Bhagyalaxmi riverfront",
    subtitle: "Weekend Home and Resort Savli-Timba Road, Near Manjusar GIDC",
    category: "Commercial",
    location: "Savli-Timba Road, Near Manjusar GIDC",
    image: "/images/Blaxmi.jpg",
    status: "Ongoing",
    year: "2025",
    area: "3.2 Acres",
    units: 45,
  ...
  {
    id: 4,
    slug: "Ambawadi-sangma",
    name: "Ambawadi Sangma",
    subtitle: "Affordable 1, 2 Bhk Apartments Sangma, Padra, Vadodara",
    category: "Township",
    location: "Padra, Vadodara",
    image: "/images/Ambawadi.jpg",
    status: "Upcoming",
    year: "2026",
    area: "35 Acres",
    units: 850,
  },
  {
    ...
    slug: "ambawadi",
    name: "Ambawadi",
    subtitle: "A Premium Project of Villa Plots Hetampura, Dabhoi Road, Vadodara",
    category: "Luxury",
    location: "Hetampura, Dabhoi Road, Vadodara.",
    image: "/images/ambawadi1.jpg",
    status: "Ongoing",
    year: "2024",
    area: "1.2 Acres",
    units: 48,
  ...
  },
  {
    ...
    slug: "bhagyalakshmi",
    name: "Bhagyalakshmi",
    subtitle: "Commercial and residential complex Manjusar, Vadodara",
    category: "Luxury",
    location: "Manjusar, Vadodara",
    image: "/images/bhagyalaxmi.png",
    status: "Completed",
    year: "2023",
    area: "5 Acres",
    units: 32,
  },
  {
    ...
    slug: "taj-burhani",
    name: "Taj & Burhani",
    subtitle: "Premium 2-3 BHK Apartments Fatehgunj, Vadodara",
    category: "Commercial",
    location: "Fatehgunj, Vadodara",
    image: "/images/TajBurhani.png",
    status: "Completed",
    year: "2021",
    area: "4.5 Acres",
    units: 120,
